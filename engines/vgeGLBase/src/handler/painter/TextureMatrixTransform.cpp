...
//
//#include "vgeGLBase/handler/painter/TextureMatrixTransform.hpp"
//
...
//
//
//void TextureMatrixTransform::paint ( vgeGLBase::engine::Engine *pGLEngine, vgd::node::TextureMatrixTransform *pNode )
//{
