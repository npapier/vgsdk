...
#ifndef _VGEGL_PASS_PASS_HPP
#define _VGEGL_PASS_PASS_HPP
...
struct Pass : public ::vge::pass::Pass
{
	 ...
	 */
	VGEGL_API virtual void apply(	vgeGL::technique::Technique * technique, vgeGL::engine::Engine *engine, 
...
#endif //#ifndef _VGEGL_PASS_PASS_HPP
