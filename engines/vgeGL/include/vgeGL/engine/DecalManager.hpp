...
#ifndef _VGEGL_ENGINE_DECALMANAGER_HPP
#define _VGEGL_ENGINE_DECALMANAGER_HPP
...
struct DecalManager
{
	 ...
	 */
	VGEGL_API static const bool spawnDecalPrecomputation(	vgeGL::engine::SceneManager * sceneManager, const vgm::Vec2i mouseLocation,
	 ...
	 */
	VGEGL_API static vgd::Shp< vgd::node::VertexShape > spawnDecalShape(	vgeGL::engine::SceneManager * sceneManager, const vgm::Vec3f& raySourceW, const vgm::Vec3f& rayDirectionW,
	 ...
	 */
	static VGEGL_API vgd::Shp< vgd::node::Decal > createDecal( vgd::Shp< vgd::basic::IImage > image, vgd::Shp< vgd::node::VertexShape > decalShape );
	 ...
	 */
	static VGEGL_API void synchronize( const vgm::XfBox3f& box, vgd::Shp< vgd::node::WireBox > wireBoxShape, const bool addFrontFaceCross );
...
#endif //#ifndef _VGEGL_ENGINE_DECALMANAGER_HPP
