...
struct VGD_API Texture : public vgd::node::MultiAttribute
{
	...
	enum  
	{
		...
		CLAMP_TO_EDGE = 400,	///< 
		CLAMP_TO_BORDER = 401,	///< 
		ONCE = 403,	///< Don't set texture coordinates outside the interval [0.f, 1.f]
		DEFAULT_WRAP = REPEAT	///< 
	};
	...
	enum  
	{
		MIN_FILTER = 404,	///< Choose one value among NEAREST, LINEAR (default), NEAREST_MIPMAP_NEAREST, LINEAR_MIPMAP_NEAREST, NEAREST_MIPMAP_LINEAR, LINEAR_MIPMAP_LINEAR.
		MAG_FILTER = 405,	///< Choose one value among NEAREST or LINEAR (default).
	...
	enum  
	{
		NEAREST = 406,	///< 
		LINEAR = 407,	///< 
		LINEAR_MIPMAP_NEAREST = 409,	///< 
		NEAREST_MIPMAP_NEAREST = 408,	///< 
		LINEAR_MIPMAP_LINEAR = 411,	///< 
		NEAREST_MIPMAP_LINEAR = 410,	///< 
	...
	enum  
	{
		DEPTH_COMPONENT_16 = 383,	///< a single component buffer used to store depth. A 16-bit integer is used to encode a texel.
		RGB_32F = 388,	///< A three component buffer. A 32-bit float is used to encode a texel.
		LUMINANCE_ALPHA_32F = 394,	///< A two component buffer. A 32-bit float is used to encode a texel.
		LUMINANCE_16F = 391,	///< A single component buffer. A 16-bit float is used to encode a texel.
		LUMINANCE_32F = 392,	///< A single component buffer. A 32-bit float is used to encode a texel.
		RGBA_32F = 390,	///< A four component buffer. A 32-bit float is used to encode a texel.
		DEPTH_COMPONENT_32F = 386,	///< a single component buffer used to store depth. A 32-bit float is used to encode a texel.
		RGBA_16F = 389,	///< A four component buffer. A 16-bit float is used to encode a texel.
		LUMINANCE_ALPHA_16F = 393,	///< A two component buffer. A 16-bit float is used to encode a texel.
		DEPTH_COMPONENT_24 = 384,	///< a single component buffer used to store depth. A 24-bit integer is used to encode a texel.
		AUTOMATIC = 382,	///< Choosed automatically an internal format matching the image format used by the texture.
		RGB_16F = 387,	///< A three component buffer. A 16-bit float is used to encode a texel.
		DEPTH_COMPONENT_32 = 385,	///< a single component buffer used to store depth. A 32-bit integer is used to encode a texel.
	...
	enum  
	{
		IMAGE = 380,	///< Simple image mapping
		SHADOW = 381,	///< Shadow mapping
