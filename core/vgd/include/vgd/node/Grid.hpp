...
struct VGD_API Grid : public vgd::node::VertexShape
{
	 ...
	 */
	void initializeGeometry( const float width = 1.f, const float height = 1.f, const int widthSlices = 1, const int heightSlices = 1 );
	 ...
	 */
	void initializeTexUnits( const int32 numTexUnits = 1, const int widthSlices = 1, const int heightSlices = 1 );
	 ...
	 */
	void resetTextureCoordinates( const int32 numTexUnits = 1, const int widthSlices = 1, const int heightSlices = 1 );
	//@}
