...
struct VGD_API Texture : public vgd::node::MultiAttribute
{
	...
	enum  
	{
		...
		CLAMP_TO_EDGE = 417,	///< 
		CLAMP_TO_BORDER = 418,	///< 
		ONCE = 420,	///< Don't set texture coordinates outside the interval [0.f, 1.f]
		DEFAULT_WRAP = REPEAT	///< 
	};
	...
	enum  
	{
		MIN_FILTER = 421,	///< Choose one value among NEAREST, LINEAR (default), NEAREST_MIPMAP_NEAREST, LINEAR_MIPMAP_NEAREST, NEAREST_MIPMAP_LINEAR, LINEAR_MIPMAP_LINEAR.
		MAG_FILTER = 422,	///< Choose one value among NEAREST or LINEAR (default).
	...
	enum  
	{
		NEAREST = 423,	///< 
		LINEAR = 424,	///< 
		LINEAR_MIPMAP_NEAREST = 426,	///< 
		NEAREST_MIPMAP_NEAREST = 425,	///< 
		LINEAR_MIPMAP_LINEAR = 428,	///< 
		NEAREST_MIPMAP_LINEAR = 427,	///< 
	...
	enum  
	{
		DEPTH_COMPONENT_16 = 400,	///< a single component buffer used to store depth. A 16-bit integer is used to encode a texel.
		RGB_32F = 405,	///< A three component buffer. A 32-bit float is used to encode a texel.
		LUMINANCE_ALPHA_32F = 411,	///< A two component buffer. A 32-bit float is used to encode a texel.
		LUMINANCE_16F = 408,	///< A single component buffer. A 16-bit float is used to encode a texel.
		LUMINANCE_32F = 409,	///< A single component buffer. A 32-bit float is used to encode a texel.
		RGBA_32F = 407,	///< A four component buffer. A 32-bit float is used to encode a texel.
		DEPTH_COMPONENT_32F = 403,	///< a single component buffer used to store depth. A 32-bit float is used to encode a texel.
		RGBA_16F = 406,	///< A four component buffer. A 16-bit float is used to encode a texel.
		LUMINANCE_ALPHA_16F = 410,	///< A two component buffer. A 16-bit float is used to encode a texel.
		DEPTH_COMPONENT_24 = 401,	///< a single component buffer used to store depth. A 24-bit integer is used to encode a texel.
		AUTOMATIC = 399,	///< Choosed automatically an internal format matching the image format used by the texture.
		RGB_16F = 404,	///< A three component buffer. A 16-bit float is used to encode a texel.
		DEPTH_COMPONENT_32 = 402,	///< a single component buffer used to store depth. A 32-bit integer is used to encode a texel.
	...
	enum  
	{
		IMAGE = 397,	///< Simple image mapping
		SHADOW = 398,	///< Shadow mapping
