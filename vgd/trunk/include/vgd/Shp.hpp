...
template<class T>
class Shp : public boost::shared_ptr<T>
{
public:
//private:
//
...
//    typedef typename detail::shared_ptr_traits<T>::reference reference;
	...
	{}
//	px(p), pn(p, checked_deleter<Y>()) // Y must be complete
//    {
...
//    }
	...
	template<class Y>
	Shp(Shp<Y> const & r): boost::shared_ptr<T>(r)
	{}
...
//    }
	...
	template<class Y>
	Shp(Shp<Y> const & r, boost::detail::static_cast_tag): boost::shared_ptr<T>(r, boost::detail::static_cast_tag())
	{}
...
//    }
	...
	template<class Y>
	Shp(Shp<Y> const & r, boost::detail::dynamic_cast_tag): boost::shared_ptr<T>(r, boost::detail::dynamic_cast_tag())
	{}
...
//    }
	...
	template<class Y>
	Shp( Shp<Y> const & r, boost::detail::polymorphic_cast_tag): boost::shared_ptr<T>(r, boost::detail::polymorphic_cast_tag())
	{}
//	px(dynamic_cast<element_type *>(r.px)), pn(r.pn)
//    {
//        if(px == 0)
 ...
 * @relates Shp
 */
template<class T, class U> Shp<T> static_pointer_cast(Shp<U> const & r)
{
 ...
 * @relates Shp
 */
template<class T, class U> Shp<T> dynamic_pointer_cast(Shp<U> const & r)
{
